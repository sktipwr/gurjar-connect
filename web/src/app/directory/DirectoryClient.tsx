...
export default function DirectoryClient({ isLoggedIn }: { isLoggedIn: boolean }) {
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-2 text-sm text-gray-500">
        ...
        {!isLoggedIn && (
          <a href="/api/auth/linkedin" className="ml-auto text-xs text-orange-500 hover:underline font-medium">
